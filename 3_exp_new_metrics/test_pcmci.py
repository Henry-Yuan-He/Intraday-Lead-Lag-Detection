...
def plot_cumulative_returns(returns, data_index, bucket, lookback_window, method):
    ...
    plt.plot(years, cumulative_returns*100)
    ...
    plt.grid(True)
    plt.savefig(f'./results_pcmci/cum_return_bucket{bucket}_lookback_window{lookback_window}_{method}.pdf', 
                bbox_inches='tight')
    plt.close()
...
def process_combination(args):
    ...
    file_path = f'./results_pcmci/returns_bucket{bucket}_lookback_window{lookback_window}_{method}.pkl'
