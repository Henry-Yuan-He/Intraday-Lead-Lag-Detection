...
def plot_cumulative_returns(returns, data_index, bucket, lookback_window, method, alpha):
    ...
    plt.grid(True)
    plt.savefig(f'./results_EWMA/cum_return_bucket{bucket}_lookback_window{lookback_window}_{method}_alpha{alpha}.pdf')
    plt.close()

    
def process_combination(args):
    df, bucket, lookback_window, method, alpha = args
    file_path = f'./results_EWMA/returns_bucket{bucket}_lookback_window{lookback_window}_{method}_alpha{alpha}.pkl'
    ...
    try:
        ...
        plot_cumulative_returns(strategy_returns, data_index=data.index, bucket=bucket, lookback_window=lookback_window, method=method, alpha=alpha)
...
if __name__ == '__main__':
    ...
    combinations = [(df, bucket, lookback_window, method, alpha) 
