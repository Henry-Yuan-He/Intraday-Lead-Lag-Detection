...
def plot_cumulative_returns(returns, data_index, bucket, lookback_window, method, rank_method):
    ...
    plt.grid(True)
    plt.savefig(f'./results_sort_kmeans/cum_return_bucket{bucket}_lookback_window{lookback_window}_{method}_{rank_method}.pdf')
    plt.close()

    
def process_combination(args):
    df, bucket, lookback_window, method, rank_method = args
    file_path = f'./results_sort_kmeans/returns_bucket{bucket}_lookback_window{lookback_window}_{method}_{rank_method}.pkl'
