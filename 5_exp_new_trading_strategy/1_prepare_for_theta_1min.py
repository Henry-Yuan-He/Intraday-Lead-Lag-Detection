...
def process_combination(args):
    ...
    file_path = f'./5_exp_trading_threshold/results_1min/returns_bucket{bucket}_lookback_window{lookback_window}_{method}_update_interval_t{int(update_interval_t)}_label{update_interval_label}.pkl'


    result_dir = f'./5_exp_trading_threshold/results_1min/'
...
if __name__ == '__main__':
    ...
    combinations = [(df, bucket, lookback_window, method, update_interval) 
